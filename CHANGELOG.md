...
## [4.5.1](https://github.com/PaperBell-Org/Obsidian-PaperBell/compare/v4.5.1...v4.5.1) (2025-12-22)
...
* better project management ([32c06c0](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/32c06c0a79e6b3d628de2debfa1377f2187a90f6))
...
* **makefile:** add .env.example and improve sync-paperbell target ([3f371f6](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/3f371f6b2daedf497586327ae3d1c92acea7913b))
* **makefile:** add sync-paperbell target to synchronize PaperBell folder from Obsidian vault ([7ced371](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/7ced371279a1ad5cf1d1c075e48d6e13b8222ed7))
* **management:** :sparkles: update project configurations and add new scripts ([6606dc8](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/6606dc82937059fa1048a97b7ea2477e03496e80))
...
* 🐛 fix-zotlit-templater ([5df0b91](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/5df0b91091f29326c7ed5fbca1f7437a9c92a964))
...
* 🐛 LaTeX compilation error: Counter undefined ([98937c4](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/98937c4ed6e4b8dcca05b99595d19be68d7361dd))
...
* **daily-note:** Add a note for section view feature announcement and feedback request ([2933133](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/2933133918417e63c8485229e5d9bbbe883a3307))
...
* **feature:** :bug: delete abstract field when connecting with ZotLit ([8d441d2](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/8d441d2b50d451739f613dec8c7fb68fbfe447d3))
...
* **feature:** :bug: Fixed ZotLit templator rending bug ([305c37e](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/305c37ede8ca373a63ccbddb599db67df6d6a51e))
...
* **feature:** :bug: split anno notes correctly now ([d0f13c6](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/d0f13c6dd2a095ade9f66e8e375397127c9bc0c6))
...
* **feature:** Right pack-up of section view & task genius version ([48a4db8](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/48a4db8520105eb672ce4efed1f1fe846d613e4b))
...
* **theme:** :art: 修复由于gitignore而PaperBell路径内img没有上传的问题 ([20ebc40](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/20ebc407811a11ee94edb6295b70ae49b9272843))
...
* **theme:** :bug: 修复了主页 banner 不显示的问题 ([0bbdca7](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/0bbdca7625e86355966800c2e0e38ddbee580210))
...
* Update main.js for localization and license management improvements ([ae135cf](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/ae135cf27fc3a5ba47e287ab68821bd49391c864))
...
* Update version numbers and improve plugin functionality ([9cdf763](https://github.com/PaperBell-Org/Obsidian-PaperBell/commit/9cdf7631c5c48145f274fa483eee561fa231420f))
